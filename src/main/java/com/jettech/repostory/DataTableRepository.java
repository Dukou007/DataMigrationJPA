...
public interface DataTableRepository extends JpaRepository<DataTable, Integer> {	  
	  ...
	  Page<DataTable> findByForeignKeyByPage(int test_database_id,Pageable pageable);
	  ...
	  Page<DataTable> findByForeignKeyAndTableByPage(int test_database_id,String tableName,Pageable pageable);
