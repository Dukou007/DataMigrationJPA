 ...
 */
public class ModelTestResultItemVO extends BaseVO {
	...
	public ModelTestResultItemVO(BaseEntity entity) {
		super(entity);
		if(entity!=null) {
			@SuppressWarnings("unused")
			ModelTestResultItem testResultItem=(ModelTestResultItem) entity;
		}
	}
	public ModelTestResultItemVO() {
		super();
	}
