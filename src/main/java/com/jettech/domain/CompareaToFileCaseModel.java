...
public class CompareaToFileCaseModel extends CaseModel {

	private static final Integer _DEFAULT_PAGE_SZIE = 10000;
	private QueryModel sourceQuery;
	private QueryFileModel targetQuery;

	public CompareaToFileCaseModel() {
	}

	public QueryFileModel getTargetQuery() {
		return targetQuery;
	}

	public void setTargetQuery(QueryFileModel targetQuery) {
		this.targetQuery = targetQuery;
	}

	public CompareaToFileCaseModel(TestCase testCase) throws Exception {
		super(testCase);
		...
		this.targetQuery = new QueryFileModel(testCase.getTestFileQuery());
